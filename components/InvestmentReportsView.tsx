    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      {subView === 'SUMMARY' && (
        <div className="space-y-8 animate-in slide-in-from-bottom-4">
           ...
           <div className="bg-white dark:bg-zinc-900 p-8 rounded-3xl border dark:border-zinc-800 shadow-xl flex flex-col items-center gap-6">
           ...
           <div className="bg-white dark:bg-zinc-900 rounded-3xl border dark:border-zinc-800 overflow-hidden shadow-2xl">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-right">
                   <thead>
                      <tr className="text-[10px] font-black uppercase text-zinc-400 bg-zinc-50 dark:bg-zinc-800/20 border-b dark:border-zinc-700">
                   ...
                   <tbody className="divide-y dark:divide-zinc-800 font-bold">
                      ...
                      <tr className="bg-zinc-50 dark:bg-zinc-800/50 font-black">
      ...
      {subView === 'PERFORMANCE' && (
        <div className="animate-in slide-in-from-bottom-4 space-y-6">
           <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white dark:bg-zinc-900 rounded-3xl border dark:border-zinc-800 shadow-xl overflow-hidden">
                 <div className="p-6 bg-emerald-500/10 border-b dark:border-zinc-700 border-emerald-500/20 flex items-center gap-3">
                    <Star className="text-emerald-600 dark:text-emerald-400 w-6 h-6" />
              ...
              <div className="bg-white dark:bg-zinc-900 p-8 rounded-3xl border dark:border-zinc-800 shadow-xl flex flex-col items-center justify-center text-center gap-6">
        ...
        <div className="animate-in slide-in-from-bottom-4 space-y-6">
           <div className="bg-white dark:bg-zinc-900 rounded-3xl border-2 border-amber-500/30 overflow-hidden shadow-2xl">
              <div className="p-6 bg-amber-500/10 border-b border-amber-500/20 flex items-center gap-3">
                 <Hourglass className="text-amber-600 dark:text-amber-400 w-6 h-6" />
              ...
              <div className="p-6 bg-zinc-50 dark:bg-zinc-800/50 border-t dark:border-zinc-700 flex justify-between items-center">
