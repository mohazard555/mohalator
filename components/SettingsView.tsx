...
import { 
  ...
  ShieldCheck, Database, Download, Upload, Trash2, AlertTriangle, Eye, EyeOff, Lock, User, KeyRound, Coins, Globe, Users, Briefcase, CreditCard
} from 'lucide-react';
          ...
          <div className="grid grid-cols-1 gap-6">
             ...
             <div className="grid grid-cols-2 gap-4 bg-amber-500/5 p-4 rounded-2xl border border-amber-500/20">
                <div className="flex flex-col gap-1">
                   ...
                   <input type="text" className="bg-white dark:bg-zinc-800 p-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 outline-none font-bold" value={localSettings.secondaryCurrency} onChange={e => setLocalSettings({...localSettings, secondaryCurrency: e.target.value})} />
                </div>
                <div className="flex flex-col gap-1">
                   <label className="text-[10px] text-amber-600/70 font-black uppercase mr-1">رمز العملة (2)</label>
                   <input type="text" className="bg-white dark:bg-zinc-800 p-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 outline-none font-black text-center text-amber-600" value={localSettings.secondaryCurrencySymbol} onChange={e => setLocalSettings({...localSettings, secondaryCurrencySymbol: e.target.value})} />
                </div>
             </div>
